 ...
 * Description: Pied de page éditorial avec copyright, liens secondaires et badge basse émission.
...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--greenlight-section-gap, var(--wp--preset--spacing--lg));padding-bottom:var(--greenlight-section-gap, var(--wp--preset--spacing--lg));padding-left:var(--greenlight-main-gap, var(--wp--preset--spacing--md));padding-right:var(--greenlight-main-gap, var(--wp--preset--spacing--md))">
	...
	<p class="has-on-surface-variant-color has-text-color has-small-font-size" style="letter-spacing:0.05em;text-transform:uppercase">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <strong><?php echo esc_html( strtoupper( get_bloginfo( 'name' ) ) ); ?></strong>. <?php esc_html_e( 'CONÇU POUR DURER.', 'greenlight' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<p class="has-on-tertiary-color has-text-color has-small-font-size" style="letter-spacing:0.06em;text-transform:uppercase"><?php esc_html_e( '☘ MODE BASSE ÉMISSION', 'greenlight' ); ?></p>
	<!-- /wp:paragraph -->
